...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/modules/modules.module.ts")).then(function (m) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modules_modules_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./modules/modules.module */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _modules_modules_module__WEBPACK_IMPORTED_MODULE_5__["ModulesModule"]]]
    });
  ...
  function srcAppModulesMainMainComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function MainComponent(activatedRoute, router, commonService) {
        var _this = this;
        ...
        this.router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]) {
            ...
            if (params) {
              _this.commonService.getLaunches("/?".concat(params));
            }
          }
        });
      }
    ...
    MainComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 0,
      consts: [[1, "section-content", "padding-y"], [1, "container"], [1, "heading"], [1, "row"], ["app-sidebar", "", 1, "col-md-3"], ["app-productlist", "", 1, "col-md-9"], [1, "section-footer", "border-top", "padding-y"], [1, "float-md-right"]],
      ...
      directives: [_sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_3__["SidebarComponent"], _productlist_productlist_component__WEBPACK_IMPORTED_MODULE_4__["ProductlistComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MainComponent, [{
        ...
        return [{
          ...
          type: src_app_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_2__["CommonService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppModulesProductlistProductlistComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(ProductlistComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.commonService.launchesSpaceXGlobal.subscribe(function (productData) {
            return _this2.productListArray = productData;
          });
        }
      }]);
    ...
    ProductlistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "row"], ["class", "col-md-4", 4, "ngFor", "ngForOf"], [1, "col-md-4"], ["app-product", "", 1, "card", "card-product-grid", 3, "productDetails"]],
  ...
  function srcAppModulesSidebarSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(SidebarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.commonService.launchesYearSpaceXGlobal.subscribe(function (listOfLaunchYear) {
            return _this3.listOfLaunchYear = listOfLaunchYear;
          });
        }
      }, {
        key: "selectByyear",
        value: function selectByyear(year) {
          this.isYearSelected = this.isYearSelected === year ? '' : year; // this.commonService.getLaunches(this.getprepareQueryparams());
        ...
        value: function successfulLaunch(islaunch) {
          this.islaunch = this.islaunch === islaunch ? '' : islaunch; // this.commonService.getLaunches(this.getprepareQueryparams());
        ...
        value: function successfulLanding(islanding) {
          this.islanding = this.islanding === islanding ? '' : islanding; // this.commonService.getLaunches(this.getprepareQueryparams());
        ...
        value: function getprepareQueryparams() {
          ...
          this.router.navigate([url]); //return  url
        }
      }]);
    ...
    SidebarComponent.ɵfac = function SidebarComponent_Factory(t) {
      return new (t || SidebarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_services_common_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };
      ...
      _createClass(CommonService, [{
        ...
        value: function getLaunches(params) {
          ...
          this.coreService.get(params).subscribe(function (data) {
            _this4.launchesSpaceX.next(data);

            if (isLoad) {
              _this4.filterLaunchesYear(_toConsumableArray(new Set(data.map(function (year) {
